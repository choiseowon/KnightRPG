...
public class Monster_Beholder_Ctrl : Charactor, IMonster, ISerch, IMove, IAttack, IHitDamage, IDeath, IMoneyDrop, ITargetLost
{
    public MonsterType monsterType = MonsterType.Beholder;
    ...
    void HitAttack()
    {
        ...
        Sound_Ctrl.Inst.SfSoundPlay("Laser", "Monster");
    }
